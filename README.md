...
- `scripts/build_packs.sh` – builds validated `*.gtpack` artifacts via `packc` (use `cargo binstall packc --version '^0.4' --locked`; set `PACKC_VERSION=0.4` or `PACKC_VERSION_REQ='^0.4'` in CI).
